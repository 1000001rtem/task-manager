...
public class ProjectAPI {
    ...
    public List<ProjectDTO> findAll(@RequestParam(value = "userId") @Nullable final String userId) throws AccessForbiddenException {
        return projectService.findByUserId(userId);
    }

    @GetMapping(value = "/findOne", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ProjectDTO findOne(@RequestParam(value = "projectId") @Nullable final String projectId) throws IncorrectDataException {
    ...
    @DeleteMapping(value = "/deleteProject", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
