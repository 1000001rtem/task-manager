package ru.eremin.tm.backend.config;
...
import ru.eremin.tm.backend.endpoint.AuthEndpointImpl;
import ru.eremin.tm.backend.endpoint.ProjectEndpointImpl;
import ru.eremin.tm.backend.endpoint.TaskEndpointImpl;
import ru.eremin.tm.backend.endpoint.UserEndpointImpl;
