 ...
 * 2019-05-08T18:07:28.555+03:00
 * Generated source version: 3.2.3
 */
@WebServiceClient(name = "AdminEndpointService",
        wsdlLocation = "http://localhost:80/AdminEndpoint?WSDL",
        targetNamespace = "http://endpoint.server.tm.eremin.ru/")
public class AdminEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.server.tm.eremin.ru/", "AdminEndpointService");
    public final static QName AdminEndpointPort = new QName("http://endpoint.server.tm.eremin.ru/", "AdminEndpointPort");

    static {
        URL url = null;
        try {
            url = new URL("http://localhost:80/AdminEndpoint?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AdminEndpointService.class.getName())
                    .log(java.util.logging.Level.INFO,
                            "Can not initialize the default wsdl from {0}", "http://localhost:80/AdminEndpoint?WSDL");
        }
        WSDL_LOCATION = url;
    }
