 ...
 * 2019-05-08T18:07:28.157+03:00
 * Generated source version: 3.2.3
 */
@WebServiceClient(name = "AuthorizationEndpointService",
        wsdlLocation = "http://localhost:80/AuthorizationEndpoint?WSDL",
...
public class AuthorizationEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:80/AuthorizationEndpoint?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AuthorizationEndpointService.class.getName())
                    .log(java.util.logging.Level.INFO,
                            "Can not initialize the default wsdl from {0}", "http://localhost:80/AuthorizationEndpoint?WSDL");
        }
        WSDL_LOCATION = url;
    }
