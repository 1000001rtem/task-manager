...
public class ObjectFactory {
    ...
    private final static QName _SessionValidateExeption_QNAME = new QName("http://endpoint.server.tm.eremin.ru/", "SessionValidateExeption");
    ...
    public JAXBElement<SessionValidateExeption> createSessionValidateExeption(SessionValidateExeption value) {
        return new JAXBElement<SessionValidateExeption>(_SessionValidateExeption_QNAME, SessionValidateExeption.class, null, value);
    }
