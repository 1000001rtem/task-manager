...
public interface SessionEndpoint {
    ...
    public ru.eremin.tm.server.endpoint.ResultDTO updateSession(
    ...
    @WebResult(name = "return", targetNamespace = "")
    public java.util.List<ru.eremin.tm.server.endpoint.SessionDTO> findAllSessions(
        @WebParam(name = "arg0", targetNamespace = "")
        ru.eremin.tm.server.endpoint.SessionDTO arg0
    ) throws IncorrectDataException_Exception, AccessForbiddenException_Exception;
    ...
    @WebResult(name = "return", targetNamespace = "")
    public ru.eremin.tm.server.endpoint.ResultDTO removeAllSessions(
        @WebParam(name = "arg0", targetNamespace = "")
        ru.eremin.tm.server.endpoint.SessionDTO arg0
    ) throws IncorrectDataException_Exception, AccessForbiddenException_Exception;
    ...
    @WebResult(name = "return", targetNamespace = "")
    public ru.eremin.tm.server.endpoint.ResultDTO persistSession(
        @WebParam(name = "arg0", targetNamespace = "")
        ru.eremin.tm.server.endpoint.SessionDTO arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        ru.eremin.tm.server.endpoint.SessionDTO arg1
    ...
    @WebResult(name = "return", targetNamespace = "")
    public ru.eremin.tm.server.endpoint.SessionDTO findOneSession(
        @WebParam(name = "arg0", targetNamespace = "")
        ru.eremin.tm.server.endpoint.SessionDTO arg0,
        @WebParam(name = "arg1", targetNamespace = "")
    ...
    @WebResult(name = "return", targetNamespace = "")
    public ru.eremin.tm.server.endpoint.ResultDTO removeSession(
        @WebParam(name = "arg0", targetNamespace = "")
        ru.eremin.tm.server.endpoint.SessionDTO arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        java.lang.String arg1
    ...
    @WebMethod
    @Action(input = "http://endpoint.server.tm.eremin.ru/SessionEndpoint/sessionValidateRequest", output = "http://endpoint.server.tm.eremin.ru/SessionEndpoint/sessionValidateResponse", fault = {@FaultAction(className = IncorrectDataException_Exception.class, value = "http://endpoint.server.tm.eremin.ru/SessionEndpoint/sessionValidate/Fault/IncorrectDataException"), @FaultAction(className = AccessForbiddenException_Exception.class, value = "http://endpoint.server.tm.eremin.ru/SessionEndpoint/sessionValidate/Fault/AccessForbiddenException")})
