...
public interface TaskEndpoint {
    ...
    @WebMethod
    @Action(input = "http://endpoint.server.tm.eremin.ru/TaskEndpoint/sessionValidateRequest", output = "http://endpoint.server.tm.eremin.ru/TaskEndpoint/sessionValidateResponse", fault = {@FaultAction(className = IncorrectDataException_Exception.class, value = "http://endpoint.server.tm.eremin.ru/TaskEndpoint/sessionValidate/Fault/IncorrectDataException"), @FaultAction(className = AccessForbiddenException_Exception.class, value = "http://endpoint.server.tm.eremin.ru/TaskEndpoint/sessionValidate/Fault/AccessForbiddenException")})
