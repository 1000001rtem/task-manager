 ...
 * 2019-05-08T18:07:27.906+03:00
 * Generated source version: 3.2.3
 */
@WebServiceClient(name = "TaskEndpointService",
        wsdlLocation = "http://localhost:80/TaskEndpoint?WSDL",
...
public class TaskEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:80/TaskEndpoint?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TaskEndpointService.class.getName())
                    .log(java.util.logging.Level.INFO,
                            "Can not initialize the default wsdl from {0}", "http://localhost:80/TaskEndpoint?WSDL");
        }
        WSDL_LOCATION = url;
    }
