 ...
 * 2019-05-08T18:07:28.721+03:00
 * Generated source version: 3.2.3
 */
@WebServiceClient(name = "UserEndpointService",
        wsdlLocation = "http://localhost:80/UserEndpoint?WSDL",
...
public class UserEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:80/UserEndpoint?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserEndpointService.class.getName())
                    .log(java.util.logging.Level.INFO,
                            "Can not initialize the default wsdl from {0}", "http://localhost:80/UserEndpoint?WSDL");
        }
        WSDL_LOCATION = url;
    }
